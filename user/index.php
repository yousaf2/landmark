    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper" style="min-height: 0px !important;">
            ...
            <div class="page-content fade-in-up">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">
                                ...
                                <div class="m-b-5">Published Properties</div><i class="ti-bar-chart widget-stat-icon"></i>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                                ...
                                <div class="m-b-5">Approved Properties</div><i class="fa fa-money widget-stat-icon"></i>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">
                                ...
                                <div class="m-b-5">Pending Properties</div><i class="ti-user widget-stat-icon"></i>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Latest Property Listings</div>
            ...
            <footer class="page-footer">
                <div class="font-13">2021 © <b>Property Mark</b> - All rights reserved.</div>
                <a class="px-4" href="#" target="_blank">Support Email</a>
