...
<head>
    ...
    <title>Admincast bootstrap 4 &amp; angular 5 admin template, Шаблон админки | Invoice</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Published Properties</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index.html"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Published Properties</li>
                </ol>
            </div>
            ...
            $email = 'ali@ali.com.pk';
            $getProperties = "SELECT * FROM properties WHERE email = '".$email."'";
                $properties = mysqli_query($con, $getProperties);
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="invoice-logo">
                                    <img src="../img/pm_Propertymark.png" height="30px" />
                                </div>
                                <div>
                                    <div class="m-b-5 font-bold">Property Details</div>
                                    <ul class="list-unstyled m-t-10">
                                        <li class="m-b-5">
                                            <span class="font-strong">Property Type:</span> <?=$property_type?>
                                        </li>
                                        <li class="m-b-5">
                                            <span class="font-strong">Property Status:</span> <?=$property_status?>
                                        </li>
                                        <li>
                            ...
                            <div class="col-6 text-right">
                                <div class="clf" style="margin-bottom:30px;">
                                    <div class="m-b-5 font-bold">Property Location</div>
                                        <li class="m-b-5">
                                        <span class="font-strong">Plot/Building/House No:</span> <?=$plot?>
                                        </li>
                                        <li class="m-b-5">
                                            <span class="font-strong">Block/Street:</span> <?=$street?>
                                        </li>
                                        <li>
                                            <span class="font-strong">Phase:</span> <?=$phase?>
                                        </li>
                                        <li>
                                            <span class="font-strong">Society/Area:</span> <?=$society?>
                                        </li>
                                        <li>
                                            <span class="font-strong">City:</span> <?=$society?>
                                        </li>
                                </div>
                                <div>
                                    <div class="m-b-5 font-bold">Poster Information</div>
                                        <li class="m-b-5">
                                        <span class="font-strong">Full Name:</span> <?=$fullname?>
                                        </li>
                                        <li class="m-b-5">
                                            <span class="font-strong">Phone Number:</span> <?=$phone?>
                                        </li>
                                        <li>
                                            <span class="font-strong">Email:</span> <?=$posteremail?>
                                        </li>
                                        <li>
                                            <span class="font-strong">Role:</span> <?=$role?>
                                        </li>
                                        <li>
